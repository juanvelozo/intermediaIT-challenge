    ...
    return (
        <Layout backgroundColor={Colors.purpleBlue}>
            ...
            <View style={{width: '100%',justifyContent:'center', marginVertical: 10}}>
                ...
                <Input control={control} name={RegisterFormFields.userPass}secureTextEntry={!showPassword} placeholder='Password'variant='outlined' color={Colors.orange}leading={()=><Icon name="lock"size={20}/>}trailing={()=><Pressable onPress={handleShowPassword}><Icon name={showPassword ? 'eye-off':'eye'} size={20}/></Pressable>}/>
                <VStack spacing={10} >
